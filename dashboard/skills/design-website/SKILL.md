...
```bash
python3 /home/deploy/KITech/scripts/skills/design-website/scripts/read_prospect.py \
  --url "SHEET_URL" \
  --row ROW_NUMBER \
...
python3 /home/deploy/KITech/scripts/skills/design-website/scripts/read_prospect.py \
  --url "SHEET_URL" --row 1 | \
python3 /home/deploy/KITech/scripts/skills/design-website/scripts/generate_website.py
```
Or with a JSON file:
```bash
python3 /home/deploy/KITech/scripts/skills/design-website/scripts/generate_website.py < prospect.json
```
